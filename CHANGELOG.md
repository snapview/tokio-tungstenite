...
- Update `tungstenite` to match `0.23.0` [https://github.com/snapview/tokio-tungstenite/issues/334](https://github.com/snapview/tokio-tungstenite/issues/334)

## 0.22.0

- Update TLS dependencies.
- ~~Update `tungstenite` to match `0.22.0`~~ [https://github.com/snapview/tokio-tungstenite/issues/334](https://github.com/snapview/tokio-tungstenite/issues/334)
